...
CREATE TABLE `Student` (
  `sid` VARCHAR(10) NOT NULL default 'U1230',
...
CREATE TABLE `Company` (
  `cid` VARCHAR(10) NOT NULL default 'C1210',
...
INSERT INTO `Company` VALUES ('C4785','MAC', 'jobs111','Apple','Cupertino','Technology');
INSERT INTO `Company` VALUES ('C7234','Microsoft', 'Mic2008','Microsoft','Washington','Technology');
...
INSERT INTO `Request` VALUES ('U1245','U4785','accepted','2017-10-20 08:06:10', '2017-10-20 08:16:10');
...
INSERT INTO `Message` VALUES ('U1245','U4785','hi','2017-10-20 08:06:10','0');
...
INSERT INTO `Message` VALUES ('U1245','U4785','how is it going?','2018-03-20 12:06:10','0');
...
INSERT INTO `Notification` VALUES ('A1245','U1245','2017-10-20 08:06:13','1');
INSERT INTO `Notification` VALUES ('A4785','U4785','2017-11-20 08:22:13','1');
...
INSERT INTO `Notification` VALUES ('A1245','U1246','2018-03-20 08:16:13','0');
select * from company;
...
select * from student;
select * from follower f join student s on f.sid = s.sid;

set sql_safe_updates= 0; 
UPDATE Student set phone = '123', email = '' where loginname = 'Yu';
UPDATE Student set phone = '223', email = '2222' where loginname = 'Tang';
